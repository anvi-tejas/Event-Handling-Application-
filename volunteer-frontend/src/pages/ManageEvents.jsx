...
function ManageEvents() {
  ...
  // ================= BADGE =================
  const badge = (status) => {
    if (status === "APPROVED") return "bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg shadow-green-500/30";
    if (status === "REJECTED") return "bg-gradient-to-r from-red-500 to-pink-600 text-white shadow-lg shadow-red-500/30";
